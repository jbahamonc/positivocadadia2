...
<body>
	...
	<script type="text/javascript" src="styles/js/froala_editor.min.js"></script>
	<!-- Include Plugins. -->
    <script type="text/javascript" src="styles/js/plugins/align.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/char_counter.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/code_beautifier.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/code_view.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/colors.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/emoticons.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/entities.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/file.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/font_family.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/font_size.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/fullscreen.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/image.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/image_manager.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/inline_style.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/line_breaker.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/link.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/lists.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/paragraph_format.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/paragraph_style.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/quick_insert.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/quote.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/table.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/save.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/url.min.js"></script>
    <script type="text/javascript" src="styles/js/plugins/video.min.js"></script>
	<script>
        $(function() {
            $('#edit').froalaEditor({
            	height: 500,
